...
<% if(errMsg != null && !errMsg.isEmpty()) {%>
    ...
    <div class="container " style="margin-top: 90px;">
       <div><h1 id=title>ADD EMPLOYEE</h1></div> 
        ...
        <form class="my-card" action="./addEmpDetails" method="post">
            <div class="form-row " >
                ...
                <div class="col-sm-6">
                    ...
                    <p id="ferror" style="color: red; display:none; font-size: 12px;">Valid name</p>

                </div>
               
                <div class=" col-sm-6" style="margin-top: -24px;"><br>
                    <label for="validationDefault02"><b>Employee Id</b></label>
                    <input type="number" class="form-control" id="pname" name="empId" placeholder="Valid Id" required>
                    <p id="perror"  style="color: red; display:none; font-size: 12px;">Employee Id</p>
                ...
                <div class="col-sm-6"><br>
                    ...
                    <p id="pele" style="color: red; display:none; font-size: 12px;">Valid password</p>
                </div>
                
                  <div class=" col-sm-6"><br>
                    <label for="validationDefault02"><b>Employee Designation</b></label>
                    <input type="text" class="form-control" id="pname" name="designation" placeholder="Designation" required>
                 <!--    <p id="perror"  style="color: red; display:none; font-size: 12px;"></p> -->
            ...
            <div class="  col-sm-6" ><br>
                ...
                <select class="custom-select" name="region" >
                 ...
                 <div style="float: left;"><br><br><br><br><br><br>
