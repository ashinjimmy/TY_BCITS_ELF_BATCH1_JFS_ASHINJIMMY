...
<% if(errMsg != null && !errMsg.isEmpty()) {%>
       ...
       <div><h1 id=title>SIGN UP PAGE</h1></div> 
        ...
        <form class="my-card" action="./consumerSignUp" method="post">
            <div class="form-row " >
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text"  class="form-control"  id="fname" name="firstName" pattern="[A-Za-z\s]{1,15}" maxlength="10" placeholder= "Example: Mark" title="First character starts with Upper case"  >
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control" id="lname" name="lastName"  pattern="[A-Za-z\s]{1,15}" maxlength="10" title="First character starts with Upper case" placeholder=" Example: Harry" >
                ...
                <div class="col-sm-6"><br>
                    ...
                    <input id="email" name="emailId" type="email" class="form-control" 
                    pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" title="Enter valid Email 
                    Id" placeholder="Exampe: mark123@gmail.com" />
                </div>

                <div class="col-md-6 mb-2"><br>
                    <label for="validationDefault02"><b>Phone Number</b></label>
                    <input type="number" class="form-control" id="pname" name="phoneNumber" 
                    pattern="[789][0-9]{9}" minlength="10" maxlength="10"
                    placeholder="Enter valid phone number" title="Enter valid phnone number" />
                ...
                <div class="col-sm-12"><br>
                    ...
                    <input id="mname" name="rrNumber" type="text" class="form-control"  
                    pattern="[a-zA-Z0-9]{1,15}" minlength="15" maxlength="15" title="enter proper RR Number"
                    placeholder="Valid RR Number Example : BLRNRTH56176895" />
        <!--             <p id="merror" style="color: red; display:none; font-size: 12px;">provide valid 8 numbers</p> -->
                ...
                <div class="col-sm-6"><br>
                    ...
                    pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain minimum length of 8 
                    with special characters, alphabets, and numbers"
                     placeholder="Valid password Example : Mark12@%" />
                ...
                <div class="col-md-6 mb-2"><br>
                    ...
                    <input id="cname" type="password" name="confirmed" class="form-control"  placeholder="Valid password Example : Mark12@%" />
 ...
 <div class="col-sm-12"><br>
                    ...
                    <input id="mname" name="houseNumber" type="text" class="form-control"  placeholder="Address line 1 Example : 456783" required>
                ...
                <div class="col-sm-6"><br>
                    ...
                    <input id="password"  name="pinCode" type="number" class="form-control" placeholder="Pin code Example: 560098" required>
