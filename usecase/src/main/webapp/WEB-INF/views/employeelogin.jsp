...
<body>
    ...
    <div class="col-md-4 col-sm-12  col-10 col-4 offset-md-4   offset-1 card card-body mt-5 my-card">
        ...
        <form action="/HomePage/employeehomepage.html" onsubmit="return validateForm()">
            ...
            <div class="form-group">
                ...
                <input id="email" type="email" placeholder="vailidemail@gmail.com" class="form-control">
                <p id="eele" style="color: red; display:none; font-size: 12px;">provide valid emailId</p>
            </div>
            <div class="form-group">
                <label for="exampleInputPassword1">Password</label>
                <input  id="password" type="password" placeholder="Mark$123%" class="form-control" >
